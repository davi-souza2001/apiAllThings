...
const updateSubmitNoteSpy = jest.fn();
...
describe('Submit user', () => {
    ...
    it('Should be able to edit the note', async () => {

        await expect(submitNote.executeUpdate("asd", {
            content: 'adasd',
            title: 'asdasd',
            type: 'asdas',
            idPage: 'asdsa'
        ...
        expect(updateSubmitNoteSpy).toHaveBeenCalled();
    })

    it('Should not be able to edit a note without id', async () => {

        await expect(submitNote.executeUpdate("", {
            content: 'adasd',
            title: 'asdasd',
            type: 'asdas',
            idPage: 'asdsa'
    ...
    it('Should not be able to edit a note without content', async () => {
    ...
    it('Should not be able to edit a note without title', async () => {
    ...
    it('Should not be able to edit a note without type', async () => {
    ...
    it('Should not be able to edit a note without idPage', async () => {
